...
- Add `YarpSensorBridge::disableJointEncoderAccelerationReading` function to disable reading of joint encoder acceleration measurements (https://github.com/ami-iit/bipedal-locomotion-framework/pull/876)
